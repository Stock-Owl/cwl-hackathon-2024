...
# second value (int) notates the amount of mines
minesweeper_difficulties: dict[str, int] = {"easy": 10, "medium": 18, "hard": 26}

binary_operations: list[str] = ["AND", "OR", "XOR", "NOR", "XNOR", "NAND", "NOT"]